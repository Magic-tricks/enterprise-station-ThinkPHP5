...
/*
  -- ----------------------------
  -- bik_auth_rule，规则表，
  -- id:主键，name：规则唯一标识, title：规则中文名称 status 状态：为1正常，为0禁用，condition：规则表达式，为空表示存在就验证，不为空表示按照条件验证，pid：用来查找子权限 ,level :显示分级 ,sort :排序
  -- ----------------------------
  DROP TABLE IF EXISTS `bik_auth_rule`;
  ...
  -- ----------------------------
  DROP TABLE IF EXISTS `bik_auth_group`;
  ...
  -- ----------------------------
  DROP TABLE IF EXISTS `bik_auth_group_access`;
